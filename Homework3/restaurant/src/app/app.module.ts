...
export class AppModule {
  ...
  constructor() {
    ...
    // firebase.database().ref('Breakfast').push().set(this.breakfastItems);
    // firebase.database().ref('Lunch').push().set(this.lunchItems);
    // firebase.database().ref('Dinner').push().set(this.dinnerItems);
    // firebase.database().ref('Drinks').push().set(this.drinkItems);
    // firebase.database().ref('Desserts').push().set(this.dessertItems);
    // firebase.database().ref('Other').push().set(this.otherItems);
  }
}
